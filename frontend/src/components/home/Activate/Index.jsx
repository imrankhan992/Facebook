...
const ActivateEmailHome = () => {
  ...
  const { isLoading, data, isError, error, isPaused,isFetching,status } = useQuery({
  ...
  return (
    <Index>
      ...
      <ActivateEmail isLoading={isLoading} data={data} isError={isError} error={error} isPaused={isPaused} isFetching={isFetching} status={status}/>
        {/* Left Section */}
